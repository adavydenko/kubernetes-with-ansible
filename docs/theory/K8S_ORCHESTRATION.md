...
### Связь безопасности, производительности и эксплуатации

В реальной эксплуатации решения по **безопасности** (RBAC, политики, сеть), **производительности** (запросы/лимиты, QoS, планирование) и **операциям** (GitOps, бэкапы, мониторинг, обновления) не существуют изолированно: они влияют друг на друга. Схема ниже задаёт общий «каркас» тем, к которым вы будете возвращаться по мере усложнения кластера.

![Диаграмма 14: принципы безопасности, производительности и операций](../diagram-assets/images/diagram-14-security-principles.svg)
